            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-6 text-end">
                        <a href="/product" class="btn btn-outline-warning"><i class="fa-solid fa-list me-2"></i> Danh
                            sách sản phẩm</a>
                    </div>
                </div>
            </div>
                    ...
                    <form action="" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                        <div class="row">
                            <div class="col-6">
                                ...
                                echo '<img id="image_preview" src="' . ImageHelper::getDisplayStringData($product->getImageUrl()) . '" onerror="this.onerror=null; this.src=\'/image/product-default-image.png\';">';
                                ?>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="barcode" name="barcode"
                                           value="<?php echo $product->getBarcode(); ?>" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="radio" id="category_phone" name="category"
                                               value="Điện thoại" <?php echo ($product->getCategoryName() == 'Điện thoại') ? 'checked' : ''; ?>
                                               required>
                                        <label for="category_phone">Điện thoại</label>

                                    </div>
                                    <div>
                                        <input type="radio" id="category_accessory" name="category"
                                               value="Phụ kiện" <?php echo ($product->getCategoryName() == 'Phụ kiện') ? 'checked' : ''; ?>
                                               required>
                                        <label for="category_accessory">Phụ kiện</label>
                                    </div>
                                    <div>
                                        <input type="radio" id="category_other" name="category"
                                               value="Khác" <?php echo ($product->getCategoryName() == 'Khác') ? 'checked' : ''; ?>
                                               required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="import_price" name="import_price"
                                           value="<?php echo $product->getImportPrice(); ?>">
                                ...
                                <button type="button" class="btn btn-secondary" onclick="window.history.back();">Đóng
                                </button>
                            </div>
                        </div>
                    </form>
